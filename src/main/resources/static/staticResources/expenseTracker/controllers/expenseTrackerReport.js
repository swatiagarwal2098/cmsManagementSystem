	...
	this.getExpenseTrackerDataReportList = function($scope, inputJson) {
		...
		scrollX: true,
			...
			initComplete: function(settings, json) {
				if (!sessionCheckForAjaxCodeText(json.sessionExpired, logoutPath))
					return false;
				$("#totalCount").html(json.data.length);
				dataTableColumnSearch('dataTable');
				//resizeDataTable('dataTable');
